...
**** Tu tarea
1. Escribe al menos *6 triples* en español o en notación =(sujeto, predicado, objeto)= tomados del HTML (usa identificadores inventados si hace falta, p. ej. =ex:alicia=).
2. Escribe al menos *4 triples* tomados del JSON.
3. Señala *un triple* que aparece «casi igual» en ambas fuentes pero con *sujetos distintos* si no unificas identificadores. Explica por qué eso es un problema para una máquina.
